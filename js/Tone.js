...
Module(function (Tone) {
		 ...
		 */
	    Tone.SamplerExt.prototype.triggerAttackExt = function (note, time, velocity, start, length) {
	        ...
	        if (difference !== null) {
	            ...
	            source.start(time, start, length, velocity);
		 ...
		 * @return {Tone.SamplerExt}	this
		 */
	    Tone.SamplerExt.prototype.releaseAll = function (time) {
	        time = this.toSeconds(time);
		 ...
		 * @returns {Tone.Instrument} this
		 */
	    Tone.SamplerExt.prototype.sync = function () {
	        this._syncMethod('triggerAttack', 1);
	        this._syncMethod('triggerRelease', 1);
	        return this;
	    };
	...
	Module(function (Tone) {
		 ...
		 */
	    Tone.Sampler.prototype.triggerAttackExt = function (note, time, velocity, offset, duration) {
	        var midi = Tone.Frequency(note).toMidi();
	        // find the closest note pitch
	        var difference = this._findClosest(midi);
	        if (difference !== null) {
		 ...
		 * @name buffer
		 */
		Object.defineProperty(Tone.Sampler.prototype, "buffers", {
			get : function(){
